# 👋 Hi, I'm Konstantinos (felagund1789)

I am a full-stack developer with experience building dynamic and engaging web applications. Currently, my focus is primarily on front-end development, developing applications in React and Typescript, while also trying my hand at game development.
...
- **Tools & Platforms:** 
  ...
  ![Maven](https://img.shields.io/badge/Maven-C71A16?style=flat-square&logo=apachemaven&logoColor=white)
...
### [🎶 Spotify Warped](https://github.com/felagund1789/spotify-warped) ![React](https://img.shields.io/badge/React-%2320232a.svg?style=flat-square&logo=react&logoColor=%2361DAFB) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![React Query](https://img.shields.io/badge/React_Query-%23FF4154.svg?style=flat-square&logo=react-query&logoColor=white)
Spotify Warped is an interactive React + TypeScript application that creates your personalized "Spotify Warped" experience. Navigate through your top music data with an immersive 3D carousel interface, swipe gestures for mobile, and warp-like loading animations. Features OAuth2 authentication, React Query for data caching and time range selection.
...
### [👤 Login Form](https://github.com/felagund1789/login-form) ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![CSS3](https://img.shields.io/badge/CSS3-663399?style=flat-square&logo=css&logoColor=white) ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black)
...
### [🌍 Tiny God](https://github.com/felagund1789/TinyGod)
Tiny God is a minimalist god game prototype created for the GameDev.tv Game Jam 2025, where you play as a divine being watching over a tiny spherical planet. Shape the land, control the weather, and guide (or smite) the primitive creatures who call your world home. The project was developed together with [jimstav](https://github.com/jimstav).
...
- **GitHub:** [https://github.com/felagund1789](https://github.com/felagund1789)
